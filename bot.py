Sure, here's the Python 2 code for the same functionality:
...
Once you have joined the channel, click the /start command to restart the bot."
    ...
    urllib2.urlopen(telegram_api, urllib.urlencode(params))
    return
...
To use this code, replace `YOUR_TELEGRAM_BOT_TOKEN` and `YOUR_TELEGRAM_CHANNEL_USERNAME` with your own values. You can then use this code in your Python 2 Telegram bot to force users to join your channel
